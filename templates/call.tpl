      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <p>ROCLING 2025 invites paper submissions reporting original research results and system development experiences as well as real-world applications. Each submission will be reviewed based on originality, significance, technical soundness, and relevance to the conference.</p>
            ...
            <p>
            <strong>Special Sessions</strong>: ROCLING 2025 will feature three special sessions that focus on emerging and interdisciplinary topics in computational linguistics. Papers submitted to these sessions will follow the same submission process as the main conference but will be reviewed independently by specialized committees.
            </p>
            <p>
	...
	Submitted papers may consist of 4-8 pages of content, plus unlimited references. Upon acceptance, final versions will be given additional pages of content (up to 9 pages) so that reviewers’ comments can be taken into account.</p>
            ...
            -->
            <p>
            <strong>Scope</strong>: We welcome the submission of papers from natural language processing and speech processing topics. Topics include:
            </p>
            <!--<p>ROCLING 2025 mainly targets two scientific tracks: natural language processing and speech processing. The generative artificial intelligence topic is also welcomed.</p>-->
            <div class="row">
              <div class="col-lg-6">
                ...
                <ul>
                  ...
                  <li>Efficient Compute for Training and Inference LLM</li>
                  <li>Safety and Alignments</li>
                  <li>Machine Translation</li>
                  <li>NLP Applications</li>
                  <li>Phonology, Morphology and Word Segmentation</li>
                  <li>Question Answering</li>
              ...
              <div class="col-lg-6">
                ...
                <ul>
                  ...
                  <li>Speaker and Language Identification</li>
                  <li>Analysis of Speech and Audio Signals</li>
                  <li>Self-supervised Speech Representation</li>
                  <li>Speech Coding and Enhancement</li>
                  <li>Spoken Language Model</li>
                  <li>Speech Synthesis and Spoken Language Generation</li>
                  <li>Speech Recognition</li>
                  <li>Spoken Dialogue Systems and Analysis of Conversation</li>
                  <li>Spoken Language Processing: Retrieval, Translation, Summarization, Resources and Evaluation</li>
                  <li>Others</li>
                </ul>
              </div>
